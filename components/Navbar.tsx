  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 28px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        {/* Logo */}
        {/* The lockup already carries the FSLABS wordmark, so no adjacent text. */}
        <Link href="/" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
          <Image src="/fslabs-logo-horizontal-on-dark.png" alt="FSLabs" width={184} height={40} priority style={{ flexShrink: 0, width: "auto", height: 40 }} />
        </Link>
