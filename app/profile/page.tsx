...
export default function ProfilePage() {
  ...
  return (
    <motion.main
      initial="initial"
      animate="animate"
      style={{ background: "#050505", color: "#F5F0E8", minHeight: "100vh", padding: "80px 28px 60px" }}
    >
      <motion.div variants={pageTransition} style={{ maxWidth: 800, margin: "0 auto" }}>
        {/* Header */}
        <div style={{ marginBottom: 60 }}>
          <Link href="/dashboard" style={{ color: "#C9A84C", textDecoration: "none", fontSize: 14 }}>
            ← Back to Dashboard
          </Link>
        ...
        >
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            >
              {(session?.user as any)?.studentId || "Not assigned"}
            </div>
          </div>
