 ...
 * FSLabs form (fslabs.tech) so deliverability is unchanged; swap the
...
export async function POST(req: Request) {
  ...
  const [{ error }] = await Promise.all([
    ...
    resend.emails.send({
      from: "FOLUB Builders <contact@fslabs.tech>",
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #f7f4ee; border-radius: 8px;">
          ...
          <p style="color: #6E6A5F; font-size: 14px; margin-top: 0;">fslabs.tech/folub</p>
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #16283A; color: #EFE9DC; border-radius: 12px; overflow: hidden;">
          ...
          <div style="padding: 0 32px 32px;">
            ...
            <div style="background: rgba(198,162,74,0.08); border: 1px solid rgba(198,162,74,0.22); border-radius: 10px; padding: 20px; margin-bottom: 24px;">
              ...
              <a href="https://fslabs.tech/folub/properties" style="display: inline-block; background: ${gold}; color: #16283A; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 13px; letter-spacing: 0.03em;">View properties →</a>
            </div>
          </div>
